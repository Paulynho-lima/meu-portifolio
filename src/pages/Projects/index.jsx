      ...
      <section className='projectSection'>
        <Carossel settings={settings}>
          ...
          <SwiperSlide>
            ...
            <a className='fotowallet' href='https://paulynho-lima.github.io/star-wars/' target="_blank"><img src={fotoStar} alt="star-wars" class="item current-item" /></a>
          </SwiperSlide>
          ...
          <SwiperSlide>
            ...
            <a className='fotowallet' href='https://github.com/Paulynho-lima/Blogs-Api' target="_blank"><img src={fotoBlog} alt="blog-posts" class="item current-item" /></a>
          </SwiperSlide>
        </Carossel>
